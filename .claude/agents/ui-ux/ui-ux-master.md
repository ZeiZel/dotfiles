...
tools: Read, Write, Edit, Glob, Grep, WebSearch, Task, SendMessage, mcp__figma__get_file, mcp__figma__get_file_components, mcp__figma__get_file_styles, mcp__figma__get_node, mcp__figma__get_image, mcp__open-pencil__*
skills: [team-comms]
